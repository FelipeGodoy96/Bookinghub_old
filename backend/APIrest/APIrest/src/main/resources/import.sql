...
--UPDATE reservas SET reservas_usuarios  = 1 WHERE id = 1
--UPDATE reservas SET reservas_usuarios  = 1 WHERE id = 2
--UPDATE reservas SET reservas_usuarios  = 2 WHERE id = 3

--UPDATE produtos SET produtos_reservas = 1 WHERE id = 1