...
public class ReservaDto_UsuarioProduto implements Serializable {
    ...
    public ReservaDto_UsuarioProduto() {
    }

    public ReservaDto_UsuarioProduto(Integer id, Time h_inic_reser, Date d_inic_reser, Date d_fin_reser) {
        this.id = id;
    ...
    public ReservaDto_UsuarioProduto(Reservas reservas) {
        id = reservas.getId();
