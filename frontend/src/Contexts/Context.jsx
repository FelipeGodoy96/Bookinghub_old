...
const anuncios = [
  ...
  },  
  {
    ...
    description:"Torne esta estação brilhante com uma estada tropical no Copacabana Palace. Com vistas cinematográficas durante o dia e comemorações lendárias à noite, saboreie caipirinhas à beira da piscina e bronzeie-se em areias douradas. Nosso hotel tem sido um símbolo brasileiro à beira-mar por quase um século, e a sensação de glamour histórico está viva a cada passo. Enquanto seu coração deseja um almoço tranquilo sob o sol ou coquetéis ardentes às 4 da manhã, ajudaremos a manter a chama acesa no nosso oásis cultural."
  },
  {
    ...
    location: "Itabirito",
    description:"Chalés Charmosos, Ótimo Restaurante, Parque Aquático Completo, Piscina Aquecida Coberta. Cheio de Opções de Lazer e Entretenimento com uma Represa de Mais de 15 km de Extensão. Diversão para Família. Lazer para a Família"
  },
  {
